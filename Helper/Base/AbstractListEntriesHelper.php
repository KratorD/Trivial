...
abstract class AbstractListEntriesHelper
{
    ...
    public function getEntries($objectType, $fieldName)
    {
        ...
        switch ($objectType) {
            case 'tournament':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForTournament();
                        break;
                }
                break;
            case 'question':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForQuestion();
                        break;
                }
                break;
            case 'answer':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForAnswer();
                        break;
                }
                break;
            case 'result':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForResult();
                        break;
                }
                break;
            case 'appSettings':
     ...
     * @return array Array with desired list entries
     */
    public function getWorkflowStateEntriesForTournament()
    {
        $states = [];
        $states[] = [
            'value'   => 'approved',
     ...
     * @return array Array with desired list entries
     */
    public function getWorkflowStateEntriesForQuestion()
    {
        $states = [];
        $states[] = [
            'value'   => 'approved',
     ...
     * @return array Array with desired list entries
     */
    public function getWorkflowStateEntriesForAnswer()
    {
        $states = [];
        $states[] = [
            'value'   => 'approved',
     ...
     * @return array Array with desired list entries
     */
    public function getWorkflowStateEntriesForResult()
    {
        $states = [];
        $states[] = [
            'value'   => 'approved',
