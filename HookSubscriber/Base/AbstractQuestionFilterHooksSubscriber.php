 ...
 */
abstract class AbstractQuestionFilterHooksSubscriber implements HookSubscriberInterface
{
    /**
    ...
    /**
     * QuestionFilterHooksSubscriber constructor.
     *
    ...
    {
        return $this->translator->__('Question filter hooks subscriber');
    }
    ...
    {
        return [
            FilterHooksCategory::TYPE_FILTER => 'zikulatrivialmodule.filter_hooks.questions.filter'
        ];
    }
}
