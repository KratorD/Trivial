 ...
 */
abstract class AbstractTournamentFilterHooksSubscriber implements HookSubscriberInterface
{
    /**
    ...
    /**
     * TournamentFilterHooksSubscriber constructor.
     *
    ...
    {
        return $this->translator->__('Tournament filter hooks subscriber');
    }
    ...
    {
        return [
            FilterHooksCategory::TYPE_FILTER => 'zikulatrivialmodule.filter_hooks.tournaments.filter'
        ];
    }
}
