 ...
 *
 * This is the base repository class for tournament entities.
 */
abstract class AbstractTournamentRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'Zikula\TrivialModule\Entity\TournamentEntity';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'ZikulaTrivialModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'tournaments', 'userid' => $userId];
     ...
     *
     * @return array|tournamentEntity Retrieved data array or tournamentEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved tournamentEntity instances
     */
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if ((!$useJoins || !$slimMode) && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('tournament', $qb);
        }
    ...
    public function selectSearch($fragment = '', array $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('tournament', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numTournaments';
        if (true === $useJoins) {
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('tournament', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of tournaments to exclude (optional)
     *
     * @return boolean Result of this check, true if the given tournament does not already exist
     */
    ...
    {
        $qb->leftJoin('tbl.questions', 'tblQuestions');
