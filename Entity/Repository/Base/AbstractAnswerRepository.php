 ...
 *
 * This is the base repository class for answer entities.
 */
abstract class AbstractAnswerRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'Zikula\TrivialModule\Entity\AnswerEntity';

    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'answer';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'ZikulaTrivialModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'answers', 'userid' => $userId];
     ...
     *
     * @return array|answerEntity Retrieved data array or answerEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved answerEntity instances
     */
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if ((!$useJoins || !$slimMode) && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('answer', $qb);
        }
    ...
    public function selectSearch($fragment = '', array $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('answer', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numAnswers';
        if (true === $useJoins) {
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('answer', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of answers to exclude (optional)
     *
     * @return boolean Result of this check, true if the given answer does not already exist
     */
    ...
    {
        $qb->leftJoin('tbl.question', 'tblQuestion');
