 ...
 *
 * This is the base repository class for question entities.
 */
abstract class AbstractQuestionRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'Zikula\TrivialModule\Entity\QuestionEntity';

    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'question';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'ZikulaTrivialModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'questions', 'userid' => $userId];
     ...
     *
     * @return array|questionEntity Retrieved data array or questionEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved questionEntity instances
     */
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if ((!$useJoins || !$slimMode) && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('question', $qb);
        }
    ...
    public function selectSearch($fragment = '', array $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('question', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numQuestions';
        if (true === $useJoins) {
    ...
    public function selectCount($where = '', $useJoins = false, array $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('question', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of questions to exclude (optional)
     *
     * @return boolean Result of this check, true if the given question does not already exist
     */
