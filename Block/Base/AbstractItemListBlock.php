...
namespace Zikula\TrivialModule\Block\Base;

use Zikula\BlocksModule\AbstractBlockHandler;
use Zikula\Core\AbstractBundle;
use Zikula\TrivialModule\Helper\FeatureActivationHelper;
use Zikula\TrivialModule\Block\Form\Type\ItemListBlockType;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function __construct(AbstractBundle $bundle)
    {
        ...
        $this->categorisableObjectTypes = ['question'];
    }
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('ZikulaTrivialModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        // create query
        $orderBy = $this->get('zikula_trivial_module.model_helper')->resolveSortParameter($objectType, $properties['sorting']);
        ...
        if (in_array($objectType, $this->categorisableObjectTypes)) {
            if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $properties['objectType'])) {
                $categoryHelper = $this->get('zikula_trivial_module.category_helper');
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('ZikulaTrivialModule items');
        }
        ...
        $templateParameters = $this->get('zikula_trivial_module.controller_helper')->addTemplateParameters($properties['objectType'], $templateParameters, 'block', []);
    ...
    protected function getDisplayTemplate(array $properties = [])
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($templating->exists('@ZikulaTrivialModule/' . $templatePath)) {
                $template = '@ZikulaTrivialModule/' . $templatePath;
                break;
            }
        }
    ...
    public function getFormOptions()
    {
        ...
        return [
            ...
            'category_helper' => $this->get('zikula_trivial_module.category_helper'),
            'feature_activation_helper' => $this->get('zikula_trivial_module.feature_activation_helper')
        ];
    }
    ...
    {
        return '@ZikulaTrivialModule/Block/itemlist_modify.html.twig';
    }
