...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from trivial app';
     *     $event->getRequest()->attributes->set('ZikulaTrivialModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('ZikulaTrivialModule_test');`
     *     now `$testMessage` should be: `'Hello from trivial app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('trivial App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
