...
abstract class AbstractWorkflowEventsListener implements EventSubscriberInterface
{
    ...
    public function onGuard(GuardEvent $event)
    {
        ...
        if (!$this->permissionApi->hasPermission('ZikulaTrivialModule:' . ucfirst($objectType) . ':', $entity->getKey() . '::', $permissionLevel)) {
        ...
        if ($transitionName == 'delete') {
            ...
            if ($objectType == 'tournament') {
                $isBlocked = false;
                if (count($entity->getQuestions()) > 0) {
                    $isBlocked = true;
                }
