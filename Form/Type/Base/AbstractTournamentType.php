...
/**
 * Tournament editing form type base class.
 */
abstract class AbstractTournamentType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addEntityFields(FormBuilderInterface $builder, array $options = [])
    {
        ...
        $builder->add('name', TextType::class, [
            ...
            'attr' => [
                'maxlength' => 50,
                'class' => '',
                'title' => $this->__('Enter the name of the tournament')
            ],
            'required' => true,
        ]);
        ...
        $builder->add('nQuestions', IntegerType::class, [
            'label' => $this->__('N questions') . ':',
            'empty_data' => '0',
            'attr' => [
                'maxlength' => 4,
                'class' => '',
                'title' => $this->__('Enter the n questions of the tournament.') . ' ' . $this->__('Only digits are allowed.')
            ],
            'required' => false,
            'scale' => 0
        ]);
    ...
    {
        return 'zikulatrivialmodule_tournament';
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver
            ->setDefaults([
                ...
                'data_class' => 'Zikula\TrivialModule\Entity\TournamentEntity',
