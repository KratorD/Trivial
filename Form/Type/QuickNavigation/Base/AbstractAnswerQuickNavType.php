...
/**
 * Answer quick navigation form type base class.
 */
abstract class AbstractAnswerQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * AnswerQuickNavType constructor.
     *
    ...
    * @param EntityDisplayHelper $entityDisplayHelper EntityDisplayHelper service instance
    ...
    {
        $listEntries = $this->listHelper->getEntries('answer', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'zikulatrivialmodule_answerquicknav';
    }
}
