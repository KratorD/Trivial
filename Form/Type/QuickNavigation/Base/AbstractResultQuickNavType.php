...
/**
 * Result quick navigation form type base class.
 */
abstract class AbstractResultQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * ResultQuickNavType constructor.
     *
    ...
    {
        $listEntries = $this->listHelper->getEntries('result', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'zikulatrivialmodule_resultquicknav';
    }
}
