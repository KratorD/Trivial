...
/**
 * Tournament quick navigation form type base class.
 */
abstract class AbstractTournamentQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * TournamentQuickNavType constructor.
     *
    ...
    {
        $listEntries = $this->listHelper->getEntries('tournament', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    public function addSortingFields(FormBuilderInterface $builder, array $options = [])
    {
        $builder
            ->add('sort', ChoiceType::class, [
                ...
                'choices' =>             [
                    $this->__('Name') => 'name',
                    $this->__('Date from') => 'dateFrom',
                    $this->__('Date to') => 'dateTo',
                    $this->__('Active') => 'active',
                    $this->__('N questions') => 'nQuestions',
    ...
    {
        return 'zikulatrivialmodule_tournamentquicknav';
    }
}
