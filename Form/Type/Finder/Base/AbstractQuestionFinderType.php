...
namespace Zikula\TrivialModule\Form\Type\Finder\Base;
...
/**
 * Question finder form type base class.
 */
abstract class AbstractQuestionFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * QuestionFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the question') => 1,
                $this->__('Absolute url to the question') => 2,
                $this->__('ID of question') => 3
            ],
            'multiple' => false,
            'expanded' => false
        ]);
    ...
    {
        return 'zikulatrivialmodule_questionfinder';
    }
