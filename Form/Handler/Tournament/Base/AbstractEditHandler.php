...
namespace Zikula\TrivialModule\Form\Handler\Tournament\Base;

use Zikula\TrivialModule\Form\Handler\Common\EditHandler;
use Zikula\TrivialModule\Form\Type\TournamentType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters = [])
    {
        ...
        $this->objectTypeCapital = 'Tournament';
        $this->objectTypeLower = 'tournament';
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the tournament yet as other items are required which must be created before!'));
    ...
    {
        return $this->formFactory->create(TournamentType::class, $this->entityRef, $this->getFormOptions());
    }
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of tournament area
        $codes[] = 'userIndex';
        // admin index page of tournament area
        $codes[] = 'adminIndex';
    ...
    protected function getDefaultMessage(array $args = [], $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'submit':
                if ($this->templateParameters['mode'] == 'create') {
                    $message = $this->__('Done! Tournament created.');
                } else {
                    $message = $this->__('Done! Tournament updated.');
                }
                break;
            case 'delete':
                $message = $this->__('Done! Tournament deleted.');
                break;
            default:
                $message = $this->__('Done! Tournament updated.');
                break;
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'ZikulaTrivialModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'tournament', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
